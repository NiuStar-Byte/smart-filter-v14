...
TOKENS = [
    ...
    "TON-USDT", "AVAX-USDT", "LINK-USDT", "AAVE-USDT", "ZORA-USDT",
    "PUMP-USDT", "PEPE-USDT", "MAGIC-USDT", "SUI-USDT", 
    "ERA-USDT", "UNI-USDT", "HBAR-USDT", "SAHARA-USDT", "IP-USDT",
    "ENA-USDT", "CFX-USDT", "DOGE-USDT", "VINE-USDT", "PENGU-USDT",
    "WIF-USDT", "EIGEN-USDT", "SPK-USDT", "HYPE-USDT", "LINK-USDT",
    "POL-USDT", "SPK-USDT", "ZKJ-USDT", "KAS-USDT", "GALA-USDT",
    "ONDO-USDT", "DOT-USDT"
 ]

# TOKENS = [
#    "AERO-USDT", "BMT-USDT", "LQTY-USDT", "X-USDT", "RAY-USDT", "EPT-USDT", "ELDE-USDT", "ACTSOL-USDT", "CROSS-USDT", "KNC-USDT",
#    "AIN-USDT", "ARK-USDT", "PORTAL-USDT", "ICNT-USDT", "OMNI-USDT", "PARTI-USDT", "DUCK-USDT", "AUCTION-USDT", "ROAM-USDT",
#    "FUEL-USDT", "TUT-USDT", "SKATE-USDT", "LA-USDT", "IP-USDT", "HIPPO-USDT", "VIRTUAL-USDT", 
