...
# === LOAD ACTIVE TIMEFRAMES CONFIG ===
try:
    from symbol_config_prod import ACTIVE_TIMEFRAMES
except ImportError:
    ACTIVE_TIMEFRAMES = {"15min": False, "30min": True, "1h": True, "2h": True, "4h": True}
...
TOKENS = [
    # === 102 SYMBOLS (CORRECT - 122 total - 20 blacklist - 2026-05-12 VERIFIED) ===
    # ACTIVE SYMBOLS FILE: ACTIVE_SYMBOLS_102.txt
    # Blacklisted (20): UNI, NMR, TON, HIPPO, DUCK, FUEL, ALU, SKATE, ERA, SAHARA, BMT, X, AUCTION, AGLD, OCEAN, VOXEL, ARK, GALA, EPT, OMNI
    "BTC-USDT", "ETH-USDT", "SOL-USDT", "XRP-USDT", "ADA-USDT",
    "1INCH-USDT", "XLM-USDT", "LINK-USDT", "POL-USDT", "BNB-USDT",
    "ACE-USDT", "LA-USDT", "SPK-USDT", "ZKJ-USDT", "IP-USDT",
    "AERO-USDT", "ACH-USDT", "LQTY-USDT", "AERGO-USDT", "RAY-USDT",
    "BIGTIME-USDT", "MAGIC-USDT", "ACTSOL-USDT", "FUN-USDT", "CROSS-USDT",
    "KNC-USDT", "AIN-USDT", "AVAX-USDT", "PORTAL-USDT", "ICNT-USDT",
    "CVX-USDT", "PARTI-USDT", "VINE-USDT", "ZORA-USDT", "BNT-USDT",
    "BOME-USDT", "ROAM-USDT", "BRETT-USDT", "TUT-USDT", "CELO-USDT",
    "CELR-USDT", "TURBO-USDT", "PROMPT-USDT", "YFI-USDT", "DOGE-USDT",
    "ALGO-USDT", "DOT-USDT", "NEWT-USDT", "CHZ-USDT", "PEPE-USDT",
    "CKB-USDT", "PENGU-USDT", "CFX-USDT", "ENA-USDT", "SUI-USDT",
    "EIGEN-USDT", "HBAR-USDT", "HYPE-USDT", "PUMP-USDT", "KAS-USDT",
    "COW-USDT", "ONDO-USDT", "VIRTUAL-USDT", "AAVE-USDT", "XAUT-USDT",
    "CYS-USDT", "WIF-USDT", "BERA-USDT", "DYDX-USDT", "KAITO-USDT",
    "ARKM-USDT", "ATH-USDT", "DASH-USDT", "ARB-USDT", "WLFI-USDT",
    "BIO-USDT", "DOGS-USDT", "XPL-USDT", "AVNT-USDT", "ORDER-USDT",
    "DRIFT-USDT", "LIDO-USDT", "SAND-USDT", "SHIB-USDT", "STRK-USDT",
    "ATOM-USDT", "DUSK-USDT", "APT-USDT", "INJ-USDT", "NEAR-USDT",
    "ASTER-USDT", "OP-USDT", "RNDR-USDT", "SEI-USDT", "TAO-USDT",
    "BLUR-USDT", "LDO-USDT", "CRV-USDT", "EDU-USDT", "MERL-USDT",
    "ENS-USDT", "BONK-USDT"
]
...
def run_cycle():
    ...
    for idx, symbol in enumerate(TOKENS, start=1):
        ...
        try:
            ...
            # --- 15min TF block ---
            # CHECK: 15min disabled in config - set res15=None and skip processing
            if not ACTIVE_TIMEFRAMES.get('15min', False):
                print(f'[TF-DISABLED] 15min disabled, skipping {symbol}', flush=True)
                res15 = None
            else:
                try:
