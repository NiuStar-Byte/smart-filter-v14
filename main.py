...
TOKENS = [
    ...
    "TON-USDT", "AVAX-USDT", "LINK-USDT", "DOT-USDT", "LQTY-USDT",
...
def run():
    ...
    while True:
        ...
        def export_signal_debug_txt(**kwargs):
            # Implement your actual export logic here
            pass
        
        def send_telegram_file(filename, caption):
            # Implement your actual Telegram send logic here
            pass
        
        def run_signal_scheduler():
            global interval_signals, last_sent_hour
            while True:
                try:
                    # Signals should be appended to interval_signals elsewhere in your pipeline.
                    # Example: interval_signals.append(signal_debug_dict)
                    ...
                    if interval_signals:
                        ...
                        for debug_info in random.sample(interval_signals, num):
                            try:
                                print("[FIRED] LONG filter weights:", debug_info.get("filter_weights_long"), flush=True)
                                print("[FIRED] SHORT filter weights:", debug_info.get("filter_weights_short"), flush=True)
                                ...
                                send_telegram_file(
                                    ...
                                    caption=debug_info.get("caption", "Signal debug")
                                )
                            except Exception as e:
