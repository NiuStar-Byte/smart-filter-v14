...
class SmartFilter:
    """
    SmartFilter v14.2: Applies 18 technical filters with enhanced debug tracing,
    safe exception handling, and optional multi-timeframe volume pre-checking.
    """
    def __init__(
        self,
        symbol: str,
    ...
    def analyze(self):
        ...
        for name, method in [
            ...
            try:
                ...
                print(f"[DEBUG] {self.symbol} - Error in {name}: {e}")
                results[name] = False
