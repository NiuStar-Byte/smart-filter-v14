...
# 6. Paste it above as BOT_TOKEN
#
# 7. Search for @userinfobot
# 8. Send /start to get your Chat ID
# 9. Copy your Chat ID (numeric value)
# 10. Paste it above as CHAT_ID
#
# 11. Save this file
# 12. Restart the daemon

# For now, using placeholder values - Telegram will be disabled
# Once you add real values, restart the daemon and Telegram alerts will activate
