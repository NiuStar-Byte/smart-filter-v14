...
TOKEN_BLOCKCHAIN_INFO = {
    ...
    "XRP-USDT":   {"base": "XRP", "blockchain": "XRPL",         "consensus": "Ripple Consensus"},
    "ADA-USDT":   {"base": "ADA", "blockchain": "Cardano",      "consensus": "Ouroboros PoS"},
    "AVAX-USDT":  {"base": "AVAX","blockchain": "Avalanche",    "consensus": "Avalanche"},
    "XLM-USDT":   {"base": "XLM", "blockchain": "Stellar",      "consensus": "SCP"},
    "LINK-USDT":  {"base": "LINK","blockchain": "Ethereum",     "consensus": "PoS"},
    "POL-USDT":   {"base": "POL", "blockchain": "Polygon",      "consensus": "PoS"},
    "BNB-USDT":   {"base": "BNB", "blockchain": "BNB Chain",    "consensus": "PoSA"},
